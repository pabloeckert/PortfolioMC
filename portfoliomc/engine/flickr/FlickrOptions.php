	...
	protected function __construct() {
		$this->options = [
			...
			[
				...
				'desc'     => "To get your token secret go to <em>Photonic &rarr; Authentication &rarr; Flickr</em>, and authenticate. Save the token secret you get here. Your token secret works with the token se[...]
			...
			[
				'name'     => 'Default user',
				'desc'     => 'If no user is specified in the shortcode this one will be used. <strong>Note that this is not the username from https://www.flickr.com/photos/<span style="text-decoration: underline[...]
			...
			[
				...
				'desc'     => "<strong>This is applicable only if you are using the random tiled gallery, masonry or mosaic layouts.</strong> This size will be used as the image for the tiles. Picking a size smal[...]
				'id'       => 'flickr_tile_size',
				'grouping' => 'flickr-settings',
				'type'     => 'select',
				'options'  => [
			...
			If you are using the shortcode, the settings kick in for <code>[gallery type='flickr' user_id='abc' gallery_id='xyz']</code> to show its contents on the page, or if you use <code>[gallery type='fli[...]
			...
			[
				...
				'desc'     => "How do you want the control the number of photo thumbnails per row by default? This can be overridden by adding the '<code>columns</code>' parameter to the '<code>gallery</code>' sh[...]
